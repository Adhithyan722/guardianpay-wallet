...
export interface GuardianWalletFactoryInterface extends Interface {
...
export namespace WalletCreatedEvent {
  export type InputTuple = [
    wallet: AddressLike,
    owner: AddressLike,
    aiGuardian: AddressLike
  ];
  export type OutputTuple = [wallet: string, owner: string, aiGuardian: string];
...
export interface GuardianWalletFactory extends BaseContract {
  connect(runner?: ContractRunner | null): GuardianWalletFactory;
  waitForDeployment(): Promise<this>;

  interface: GuardianWalletFactoryInterface;
  ...
  createWallet: TypedContractMethod<
    [_owner: AddressLike, _aiGuardian: AddressLike],
    [string],
    "nonpayable"
  >;
